...
// $Id: StV0TofCorrection.cxx,v 1.1 2024/11/04 17:59:46 vanekjan Exp $
...
inline Float_t StV0TofCorrection::calcTof(
    const TLorentzVector& trackAB, const Float_t& PathAB
    ) {
  TVector3 mom = trackAB.Vect();
...
Bool_t StV0TofCorrection::correctBeta(
    const StPicoPhysicalHelix& helixA, const Float_t& TofA, Float_t& BetaCorr,
