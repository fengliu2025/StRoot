...
class StPicoCutsBase : public TNamed
{
 public:
  ...
  void setCutRequireISTorSST(bool b);
  ...
  float getTofBeta(StPicoTrack const * const trk, 
		   TLorentzVector const & secondaryMother, TVector3 const & secondaryVtx, float B) const; //new argument for magnetic field "float B", SL16j, Vanek
...
inline void StPicoCutsBase::setCutRequireISTorSST(bool b)     { mRequireISTorSST  = b; }
